/**
 * @file super.c
 * @author Wei Ting Chen (nickchen120235@sjtu.edu.cn)
 * @brief romfs implementation with extra functionality
 * 				based on the original one in the kernel source tree
 * @version 0.1
 * @date 2021-05-25
 * 
...
static int romfs_readpage(struct file *file, struct page *page)
{
	...
	int size_index;
	char* dummy;
	int path_len = strlen(file->f_path.dentry->d_name.name);
	int enc_len  = strlen(enc);
	int cmp_size = path_len < enc_len ? path_len : enc_len;
	pr_info("[readpage] current file = %s\n", file->f_path.dentry->d_name.name);
	/* end of my code */
	...
	/* my code */
	pr_info("[readpage] before read: offset = %lli, size = %lli\n", offset, size);
	/* end of my code */
...
static int __init init_romfs_fs(void)
{
	...
	/* my code */
	pr_info("custom romfs is inserted\n");
	pr_info("hide = %s\n", hide);
	pr_info("enc = %s\n", enc);
	pr_info("exec = %s\n", exec);
	/* end of my code */
...
static void __exit exit_romfs_fs(void)
{
	...
	/* my code */
	pr_info("custom romfs is removed\n");
	/* end of my code */
}
